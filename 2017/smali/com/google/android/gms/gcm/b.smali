...
.method private d(Landroid/os/Bundle;)Landroid/app/Notification;
    ...
    invoke-direct {v6, v7}, Landroid/support/v4/app/ae$d;-><init>(Landroid/content/Context;)V

    const/4 v7, 0x1

    invoke-virtual {v6, v7}, Landroid/support/v4/app/ae$d;->a(Z)Landroid/support/v4/app/ae$d;

    move-result-object v6

    invoke-virtual {v6, v2}, Landroid/support/v4/app/ae$d;->a(I)Landroid/support/v4/app/ae$d;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/app/ae$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/app/ae$d;
    ...
    invoke-virtual {v2, v1}, Landroid/support/v4/app/ae$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/app/ae$d;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/app/ae$d;->c(I)Landroid/support/v4/app/ae$d;

    :cond_1
    if-eqz v4, :cond_2

    invoke-virtual {v2, v4}, Landroid/support/v4/app/ae$d;->a(Landroid/net/Uri;)Landroid/support/v4/app/ae$d;

    :cond_2
    if-eqz v5, :cond_3

    invoke-virtual {v2, v5}, Landroid/support/v4/app/ae$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/app/ae$d;

    :cond_3
    invoke-virtual {v2}, Landroid/support/v4/app/ae$d;->a()Landroid/app/Notification;
