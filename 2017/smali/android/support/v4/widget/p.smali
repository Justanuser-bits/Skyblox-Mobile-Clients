...
.field private final f:Landroid/support/v4/widget/p$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/widget/p;->b:Landroid/view/animation/Interpolator;
    ...
    sput-object v0, Landroid/support/v4/widget/p;->c:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/View;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/p;->d:[I
    ...
    iput-object v0, p0, Landroid/support/v4/widget/p;->e:Ljava/util/ArrayList;
    ...
    .line 120
    iput-object p2, p0, Landroid/support/v4/widget/p;->i:Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/p;->h:Landroid/content/res/Resources;
    ...
    iput-object v0, p0, Landroid/support/v4/widget/p;->f:Landroid/support/v4/widget/p$a;

    .line 124
    iget-object v0, p0, Landroid/support/v4/widget/p;->f:Landroid/support/v4/widget/p$a;

    iget-object v1, p0, Landroid/support/v4/widget/p;->d:[I

    invoke-virtual {v0, v1}, Landroid/support/v4/widget/p$a;->a([I)V

    .line 126
    invoke-virtual {p0, v3}, Landroid/support/v4/widget/p;->a(I)V
...
.method private a(Landroid/support/v4/widget/p$a;)F
    .locals 6
...
.method static synthetic a(Landroid/support/v4/widget/p;)F
    .locals 1

    .prologue
    .line 52
    iget v0, p0, Landroid/support/v4/widget/p;->k:F

    return v0
.end method

.method static synthetic a(Landroid/support/v4/widget/p;F)F
    .locals 0

    .prologue
    .line 52
    iput p1, p0, Landroid/support/v4/widget/p;->k:F

    return p1
.end method

.method static synthetic a(Landroid/support/v4/widget/p;Landroid/support/v4/widget/p$a;)F
    .locals 1

    .prologue
    .line 52
    invoke-direct {p0, p1}, Landroid/support/v4/widget/p;->a(Landroid/support/v4/widget/p$a;)F
...
.method static synthetic a()Landroid/view/animation/Interpolator;
    ...
    .prologue
    .line 52
    sget-object v0, Landroid/support/v4/widget/p;->c:Landroid/view/animation/Interpolator;
...
.method private a(DDDDFF)V
    ...
    .line 133
    iget-object v1, p0, Landroid/support/v4/widget/p;->h:Landroid/content/res/Resources;
...
.method private a(FLandroid/support/v4/widget/p$a;)V
    .locals 3
...
.method static synthetic a(Landroid/support/v4/widget/p;FLandroid/support/v4/widget/p$a;)V
    .locals 0

    .prologue
    .line 52
    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/p;->b(FLandroid/support/v4/widget/p$a;)V
...
.method private b()V
    ...
    .line 418
    sget-object v2, Landroid/support/v4/widget/p;->b:Landroid/view/animation/Interpolator;
    ...
    .line 447
    iput-object v1, p0, Landroid/support/v4/widget/p;->j:Landroid/view/animation/Animation;

    .line 448
    return-void
.end method

.method private b(FLandroid/support/v4/widget/p$a;)V
    .locals 4

    .prologue
    .line 348
    invoke-direct {p0, p1, p2}, Landroid/support/v4/widget/p;->a(FLandroid/support/v4/widget/p$a;)V
    ...
    .line 351
    invoke-direct {p0, p2}, Landroid/support/v4/widget/p;->a(Landroid/support/v4/widget/p$a;)F
...
.method static synthetic b(Landroid/support/v4/widget/p;FLandroid/support/v4/widget/p$a;)V
    .locals 0
...
.method c(F)V
    ...
    .prologue
    .line 250
    iput p1, p0, Landroid/support/v4/widget/p;->g:F
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 229
    iget v2, p0, Landroid/support/v4/widget/p;->g:F
    ...
    .line 230
    iget-object v2, p0, Landroid/support/v4/widget/p;->f:Landroid/support/v4/widget/p$a;
...
.method public isRunning()Z
    ...
    .line 266
    iget-object v3, p0, Landroid/support/v4/widget/p;->e:Ljava/util/ArrayList;
...
.method public start()V
    ...
    .prologue
    .line 279
    iget-object v0, p0, Landroid/support/v4/widget/p;->j:Landroid/view/animation/Animation;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/p;->f:Landroid/support/v4/widget/p$a;
    ...
    iput-boolean v0, p0, Landroid/support/v4/widget/p;->a:Z
    ...
    .line 285
    iget-object v0, p0, Landroid/support/v4/widget/p;->i:Landroid/view/View;

    iget-object v1, p0, Landroid/support/v4/widget/p;->j:Landroid/view/animation/Animation;
