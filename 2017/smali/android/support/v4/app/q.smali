...
.method a(Ljava/lang/String;ZZ)Landroid/support/v4/app/y;
    ...
    .prologue
    .line 303
    iget-object v0, p0, Landroid/support/v4/app/q;->f:Landroid/support/v4/g/i;
    ...
    iput-object v0, p0, Landroid/support/v4/app/q;->f:Landroid/support/v4/g/i;
    ...
    invoke-direct {v0, p1, p0, p2}, Landroid/support/v4/app/y;-><init>(Ljava/lang/String;Landroid/support/v4/app/q;Z)V

    .line 310
    iget-object v1, p0, Landroid/support/v4/app/q;->f:Landroid/support/v4/g/i;
    ...
    .line 313
    :cond_2
    invoke-virtual {v0, p0}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/q;)V
...
.method a(Landroid/support/v4/g/i;)V
    ...
    .prologue
    .line 353
    iput-object p1, p0, Landroid/support/v4/app/q;->f:Landroid/support/v4/g/i;
...
.method a(Z)V
    ...
    .line 257
    iget-object v0, p0, Landroid/support/v4/app/q;->h:Landroid/support/v4/app/y;
...
.method k()Landroid/support/v4/app/s;
    .locals 1

    .prologue
    .line 205
    iget-object v0, p0, Landroid/support/v4/app/q;->d:Landroid/support/v4/app/s;

    return-object v0
.end method

.method l()Landroid/support/v4/app/y;
    .locals 3
    ...
    invoke-virtual {p0, v0, v1, v2}, Landroid/support/v4/app/q;->a(Ljava/lang/String;ZZ)Landroid/support/v4/app/y;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/q;->h:Landroid/support/v4/app/y;
...
.method n()V
    ...
    .line 239
    :cond_0
    iput-boolean v3, p0, Landroid/support/v4/app/q;->j:Z
    ...
    :cond_1
    :goto_1
    iput-boolean v3, p0, Landroid/support/v4/app/q;->i:Z
...
.method q()Landroid/support/v4/g/i;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 328
    :cond_0
    invoke-virtual {p0}, Landroid/support/v4/app/q;->m()Z
    ...
    .line 341
    iget-object v6, p0, Landroid/support/v4/app/q;->f:Landroid/support/v4/g/i;
