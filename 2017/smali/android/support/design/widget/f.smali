...
.field private n:Landroid/support/design/widget/p;
...
.method constructor <init>(Landroid/support/design/widget/ac;Landroid/support/design/widget/n;)V
    ...
    .line 44
    invoke-direct {p0, p1, p2}, Landroid/support/design/widget/h;-><init>(Landroid/support/design/widget/ac;Landroid/support/design/widget/n;)V
    ...
    iput v0, p0, Landroid/support/design/widget/f;->m:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/p;

    .line 49
    iget-object v0, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/p;

    invoke-virtual {v0, p1}, Landroid/support/design/widget/p;->a(Landroid/view/View;)V

    .line 52
    iget-object v0, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/p;

    sget-object v1, Landroid/support/design/widget/f;->h:[I

    new-instance v2, Landroid/support/design/widget/f$b;

    invoke-direct {v2, p0, v3}, Landroid/support/design/widget/f$b;-><init>(Landroid/support/design/widget/f;Landroid/support/design/widget/f$1;)V

    .line 53
    invoke-direct {p0, v2}, Landroid/support/design/widget/f;->a(Landroid/view/animation/Animation;)Landroid/view/animation/Animation;

    move-result-object v2

    .line 52
    invoke-virtual {v0, v1, v2}, Landroid/support/design/widget/p;->a([ILandroid/view/animation/Animation;)V

    .line 54
    iget-object v0, p0, Landroid/support/design/widget/f;->n:Landroid/support/design/widget/p;

    sget-object v1, Landroid/support/design/widget/f;->i:[I
    ...
    invoke-direct {v2, p0, v3}, Landroid/support/design/widget/f$c;-><init>(Landroid/support/design/widget/f;Landroid/support/design/widget/f$1;)V
...
.method private a(Landroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    .line 226
    iget v0, p0, Landroid/support/design/widget/f;->m:I
...
.method static synthetic a(Landroid/support/design/widget/f;Z)Z
    ...
    .prologue
    .line 34
    iput-boolean p1, p0, Landroid/support/design/widget/f;->o:Z
...
.method private static b(I)Landroid/content/res/ColorStateList;
    ...
    .line 272
    sget-object v2, Landroid/support/design/widget/f;->i:[I
    ...
    .line 276
    sget-object v3, Landroid/support/design/widget/f;->h:[I
...
.method a(I)V
    ...
    .prologue
    .line 120
    iget-object v0, p0, Landroid/support/design/widget/f;->c:Landroid/graphics/drawable/Drawable;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    .prologue
    .line 103
    iget-object v0, p0, Landroid/support/design/widget/f;->b:Landroid/graphics/drawable/Drawable;
    ...
    .line 106
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/f;->d:Landroid/support/design/widget/c;
...
.method a(Landroid/support/design/widget/h$a;Z)V
    ...
    .prologue
    .line 158
    iget-boolean v0, p0, Landroid/support/design/widget/f;->o:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/f;->k:Landroid/support/design/widget/ac;
    ...
    .line 185
    iget-object v1, p0, Landroid/support/design/widget/f;->k:Landroid/support/design/widget/ac;
