...
# static fields
.field private static d:Landroid/support/v7/a/p;
...
.method static a()Landroid/support/v7/a/p;
    .locals 1

    .prologue
    .line 31
    sget-object v0, Landroid/support/v7/a/p;->d:Landroid/support/v7/a/p;
    ...
    invoke-direct {v0}, Landroid/support/v7/a/p;-><init>()V

    sput-object v0, Landroid/support/v7/a/p;->d:Landroid/support/v7/a/p;
...
.method public a(JDD)V
    ...
    iput v2, p0, Landroid/support/v7/a/p;->c:I

    .line 115
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/p;->a:J

    .line 116
    const-wide/16 v2, -0x1

    iput-wide v2, p0, Landroid/support/v7/a/p;->b:J
    ...
    iput-wide v6, p0, Landroid/support/v7/a/p;->a:J
    ...
    .line 130
    iget-wide v2, p0, Landroid/support/v7/a/p;->b:J

    cmp-long v2, v2, p1

    if-gez v2, :cond_2

    iget-wide v2, p0, Landroid/support/v7/a/p;->a:J
