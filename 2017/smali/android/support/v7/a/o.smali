...
.method public constructor <init>(Landroid/support/v7/widget/Toolbar;Ljava/lang/CharSequence;Landroid/view/Window$Callback;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/o;->f:Ljava/util/ArrayList;

    .line 58
    new-instance v0, Landroid/support/v7/a/o$1;

    invoke-direct {v0, p0}, Landroid/support/v7/a/o$1;-><init>(Landroid/support/v7/a/o;)V

    iput-object v0, p0, Landroid/support/v7/a/o;->h:Ljava/lang/Runnable;

    .line 65
    new-instance v0, Landroid/support/v7/a/o$2;

    invoke-direct {v0, p0}, Landroid/support/v7/a/o$2;-><init>(Landroid/support/v7/a/o;)V

    iput-object v0, p0, Landroid/support/v7/a/o;->i:Landroid/support/v7/widget/Toolbar$OnMenuItemClickListener;
    ...
    iput-object v0, p0, Landroid/support/v7/a/o;->a:Landroid/support/v7/widget/DecorToolbar;

    .line 75
    new-instance v0, Landroid/support/v7/a/o$d;

    invoke-direct {v0, p0, p3}, Landroid/support/v7/a/o$d;-><init>(Landroid/support/v7/a/o;Landroid/view/Window$Callback;)V

    iput-object v0, p0, Landroid/support/v7/a/o;->c:Landroid/view/Window$Callback;

    .line 76
    iget-object v0, p0, Landroid/support/v7/a/o;->a:Landroid/support/v7/widget/DecorToolbar;

    iget-object v1, p0, Landroid/support/v7/a/o;->c:Landroid/view/Window$Callback;

    invoke-interface {v0, v1}, Landroid/support/v7/widget/DecorToolbar;->setWindowCallback(Landroid/view/Window$Callback;)V

    .line 77
    iget-object v0, p0, Landroid/support/v7/a/o;->i:Landroid/support/v7/widget/Toolbar$OnMenuItemClickListener;
...
.method static synthetic a(Landroid/support/v7/a/o;Landroid/view/Menu;)Landroid/view/View;
    .locals 1

    .prologue
    .line 47
    invoke-direct {p0, p1}, Landroid/support/v7/a/o;->a(Landroid/view/Menu;)Landroid/view/View;
...
.method private a(Landroid/view/Menu;)Landroid/view/View;
    ...
    .line 515
    invoke-direct {p0, p1}, Landroid/support/v7/a/o;->b(Landroid/view/Menu;)V

    .line 517
    if-eqz p1, :cond_0

    iget-object v1, p0, Landroid/support/v7/a/o;->g:Landroid/support/v7/view/menu/f;
    ...
    .line 522
    iget-object v0, p0, Landroid/support/v7/a/o;->g:Landroid/support/v7/view/menu/f;

    iget-object v1, p0, Landroid/support/v7/a/o;->a:Landroid/support/v7/widget/DecorToolbar;
...
.method static synthetic a(Landroid/support/v7/a/o;)Landroid/view/Window$Callback;
    ...
    .prologue
    .line 47
    iget-object v0, p0, Landroid/support/v7/a/o;->c:Landroid/view/Window$Callback;

    return-object v0
.end method

.method static synthetic a(Landroid/support/v7/a/o;Z)Z
    .locals 0

    .prologue
    .line 47
    iput-boolean p1, p0, Landroid/support/v7/a/o;->b:Z
...
.method private b(Landroid/view/Menu;)V
    ...
    iput-object v0, p0, Landroid/support/v7/a/o;->g:Landroid/support/v7/view/menu/f;

    .line 555
    iget-object v0, p0, Landroid/support/v7/a/o;->g:Landroid/support/v7/view/menu/f;

    new-instance v1, Landroid/support/v7/a/o$c;

    const/4 v2, 0x0

    invoke-direct {v1, p0, v2}, Landroid/support/v7/a/o$c;-><init>(Landroid/support/v7/a/o;Landroid/support/v7/a/o$1;)V
    ...
    .line 547
    :cond_2
    sget v1, Landroid/support/v7/b/a$i;->Theme_AppCompat_CompactMenu:I
...
.method static synthetic b(Landroid/support/v7/a/o;)Z
    ...
    .prologue
    .line 47
    iget-boolean v0, p0, Landroid/support/v7/a/o;->b:Z

    return v0
.end method

.method static synthetic c(Landroid/support/v7/a/o;)Landroid/support/v7/widget/DecorToolbar;
    .locals 1
...
.method private k()Landroid/view/Menu;
    ...
    iput-boolean v0, p0, Landroid/support/v7/a/o;->d:Z
...
.method public a(ILandroid/view/KeyEvent;)Z
    ...
    .line 475
    invoke-direct {p0}, Landroid/support/v7/a/o;->k()Landroid/view/Menu;
...
.method public e()Z
    ...
    iget-object v1, p0, Landroid/support/v7/a/o;->h:Ljava/lang/Runnable;
...
.method public g(Z)V
    ...
    .prologue
    .line 503
    iget-boolean v0, p0, Landroid/support/v7/a/o;->e:Z
    ...
    .line 506
    :cond_1
    iput-boolean p1, p0, Landroid/support/v7/a/o;->e:Z

    .line 508
    iget-object v0, p0, Landroid/support/v7/a/o;->f:Ljava/util/ArrayList;
