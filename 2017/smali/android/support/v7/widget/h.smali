...
.method constructor <init>(Landroid/widget/ProgressBar;Landroid/support/v7/widget/AppCompatDrawableManager;)V
    ...
    .line 48
    iput-object p1, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/ProgressBar;

    .line 49
    iput-object p2, p0, Landroid/support/v7/widget/h;->a:Landroid/support/v7/widget/AppCompatDrawableManager;
...
.method private a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method private a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 77
    invoke-direct {p0, v0, p2}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :goto_2
    invoke-direct {p0, v6, v0}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 101
    iget-object v1, p0, Landroid/support/v7/widget/h;->d:Landroid/graphics/Bitmap;

    if-nez v1, :cond_7

    .line 102
    iput-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/graphics/Bitmap;
...
.method a()Landroid/graphics/Bitmap;
    ...
    .prologue
    .line 146
    iget-object v0, p0, Landroid/support/v7/widget/h;->d:Landroid/graphics/Bitmap;
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 53
    iget-object v0, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/ProgressBar;

    invoke-virtual {v0}, Landroid/widget/ProgressBar;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v1, Landroid/support/v7/widget/h;->b:[I
    ...
    .line 58
    iget-object v2, p0, Landroid/support/v7/widget/h;->c:Landroid/widget/ProgressBar;

    invoke-direct {p0, v1}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v1, v3}, Landroid/support/v7/widget/h;->a(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
