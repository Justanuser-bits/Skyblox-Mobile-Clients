...
.method constructor <init>(Landroid/view/View;Landroid/support/v7/widget/AppCompatDrawableManager;)V
    ...
    .line 40
    iput-object p2, p0, Landroid/support/v7/widget/e;->b:Landroid/support/v7/widget/AppCompatDrawableManager;
...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 149
    iget-object v1, p0, Landroid/support/v7/widget/e;->e:Landroid/support/v7/widget/u;
    ...
    invoke-direct {v1}, Landroid/support/v7/widget/u;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/e;->e:Landroid/support/v7/widget/u;
    ...
    .line 153
    invoke-virtual {v1}, Landroid/support/v7/widget/u;->a()V

    .line 155
    iget-object v2, p0, Landroid/support/v7/widget/e;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ah;->A(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 157
    iput-boolean v0, v1, Landroid/support/v7/widget/u;->d:Z

    .line 158
    iput-object v2, v1, Landroid/support/v7/widget/u;->a:Landroid/content/res/ColorStateList;

    .line 160
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/e;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/ah;->B(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 162
    iput-boolean v0, v1, Landroid/support/v7/widget/u;->c:Z

    .line 163
    iput-object v2, v1, Landroid/support/v7/widget/u;->b:Landroid/graphics/PorterDuff$Mode;

    .line 166
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/u;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/u;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/u;[I)V
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 92
    iget-object v0, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/u;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/u;

    .line 85
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/u;

    iput-object p1, v0, Landroid/support/v7/widget/u;->a:Landroid/content/res/ColorStateList;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/u;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroid/support/v7/widget/u;->b:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/u;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    sget v3, Landroid/support/v7/b/a$j;->ViewBackgroundHelper_android_background:I
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 132
    iget-object v0, p0, Landroid/support/v7/widget/e;->c:Landroid/support/v7/widget/u;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/e;->c:Landroid/support/v7/widget/u;
...
.method c()V
    ...
    .line 120
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/u;
    ...
    .line 121
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/u;[I)V

    goto :goto_0

    .line 123
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/e;->c:Landroid/support/v7/widget/u;
