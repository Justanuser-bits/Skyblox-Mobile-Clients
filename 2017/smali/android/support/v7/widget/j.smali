...
.field private d:Landroid/support/v7/widget/u;
...
.method static a(Landroid/widget/TextView;)Landroid/support/v7/widget/j;
    .locals 2
    ...
    invoke-direct {v0, p0}, Landroid/support/v7/widget/j;-><init>(Landroid/widget/TextView;)V

    goto :goto_0
.end method

.method protected static a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/u;
    .locals 3
    ...
    .line 177
    iput-object v1, v0, Landroid/support/v7/widget/u;->a:Landroid/content/res/ColorStateList;
...
.method a()V
    ...
    .prologue
    .line 155
    iget-object v0, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/u;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/j;->c:Landroid/support/v7/widget/u;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/j;->d:Landroid/support/v7/widget/u;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/j;->e:Landroid/support/v7/widget/u;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/u;

    invoke-virtual {p0, v1, v2}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/u;)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->c:Landroid/support/v7/widget/u;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/j;->d:Landroid/support/v7/widget/u;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/j;->e:Landroid/support/v7/widget/u;

    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/j;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/u;)V
...
.method final a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/u;)V
    .locals 1
    ...
    invoke-static {p1, p2, v0}, Landroid/support/v7/widget/AppCompatDrawableManager;->tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/u;[I)V
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    .line 54
    sget-object v3, Landroid/support/v7/b/a$j;->AppCompatTextHelper:[I
    ...
    .line 56
    sget v4, Landroid/support/v7/b/a$j;->AppCompatTextHelper_android_textAppearance:I
    ...
    .line 59
    sget v4, Landroid/support/v7/b/a$j;->AppCompatTextHelper_android_drawableLeft:I
    ...
    .line 59
    invoke-static {v5, v0, v4}, Landroid/support/v7/widget/j;->a(Landroid/content/Context;Landroid/support/v7/widget/AppCompatDrawableManager;I)Landroid/support/v7/widget/u;

    move-result-object v4

    iput-object v4, p0, Landroid/support/v7/widget/j;->b:Landroid/support/v7/widget/u;
    ...
    .line 63
    sget v4, Landroid/support/v7/b/a$j;->AppCompatTextHelper_android_drawableTop:I
    ...
    iput-object v4, p0, Landroid/support/v7/widget/j;->c:Landroid/support/v7/widget/u;
    ...
    .line 67
    sget v4, Landroid/support/v7/b/a$j;->AppCompatTextHelper_android_drawableRight:I
    ...
    iput-object v4, p0, Landroid/support/v7/widget/j;->d:Landroid/support/v7/widget/u;
    ...
    .line 71
    sget v4, Landroid/support/v7/b/a$j;->AppCompatTextHelper_android_drawableBottom:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/j;->e:Landroid/support/v7/widget/u;
    ...
    .line 117
    iget-object v1, p0, Landroid/support/v7/widget/j;->a:Landroid/widget/TextView;
    ...
    .line 121
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/j;->a(Z)V
