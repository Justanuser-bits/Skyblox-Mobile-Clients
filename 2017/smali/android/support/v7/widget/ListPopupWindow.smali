...
.field private mDropDownList:Landroid/support/v7/widget/m;
...
.field private final mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ListPopupWindow$a;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V
    ...
    invoke-direct {v0, p1, p2, p3, p4}, Landroid/support/v7/widget/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0, p1, p2, p3}, Landroid/support/v7/widget/g;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method static synthetic access$500(Landroid/support/v7/widget/ListPopupWindow;)Landroid/support/v7/widget/m;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    return-object v0
.end method

.method static synthetic access$600(Landroid/support/v7/widget/ListPopupWindow;)Landroid/support/v7/widget/ListPopupWindow$e;
    .locals 1

    .prologue
    .line 65
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$e;
...
.method private buildDropDown()I
    ...
    :goto_0
    invoke-virtual {p0, v5, v0}, Landroid/support/v7/widget/ListPopupWindow;->createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/m;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/m;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/m;->setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/m;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V

    .line 1144
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/m;->setFocusable(Z)V

    .line 1145
    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/m;->setFocusableInTouchMode(Z)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/m;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V
    ...
    invoke-virtual {v0, v6}, Landroid/support/v7/widget/m;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroid/support/v7/widget/m;->measureHeightOfChildrenCompat(IIIII)I
    ...
    .line 1282
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    invoke-virtual {v1}, Landroid/support/v7/widget/m;->getPaddingTop()I

    move-result v1

    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    .line 1283
    invoke-virtual {v2}, Landroid/support/v7/widget/m;->getPaddingBottom()I
...
.method public clearListSelection()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/m;->setListSelectionHidden(Z)V
...
.method createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/m;
    .locals 1
    ...
    invoke-direct {v0, p1, p2}, Landroid/support/v7/widget/m;-><init>(Landroid/content/Context;Z)V
...
.method public dismiss()V
    ...
    .line 736
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;
...
.method public getSelectedItem()Ljava/lang/Object;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->getSelectedItem()Ljava/lang/Object;
...
.method public getSelectedItemId()J
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->getSelectedItemId()J
...
.method public getSelectedItemPosition()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->getSelectedItemPosition()I
...
.method public getSelectedView()Landroid/view/View;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->getSelectedView()Landroid/view/View;
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    .line 960
    :cond_5
    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    .line 961
    invoke-virtual {v4, v2, v1}, Landroid/support/v7/widget/m;->lookForSelectablePosition(IZ)I
    ...
    .line 962
    :cond_6
    iget-object v3, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;
    ...
    invoke-virtual {v3, v6, v2}, Landroid/support/v7/widget/m;->lookForSelectablePosition(IZ)I
    ...
    .line 977
    :cond_7
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    invoke-virtual {v6, v2}, Landroid/support/v7/widget/m;->setListSelectionHidden(Z)V

    .line 980
    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->mDropDownList:Landroid/support/v7/widget/m;

    invoke-virtual {v6, p1, p2}, Landroid/support/v7/widget/m;->onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->requestFocusFromTouch()Z
...
.method public onKeyUp(ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/m;->onKeyUp(ILandroid/view/KeyEvent;)Z
...
.method public performItemClick(I)Z
    ...
    .line 845
    invoke-virtual {v1}, Landroid/support/v7/widget/m;->getFirstVisiblePosition()I

    move-result v0

    sub-int v0, p1, v0

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/m;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    .line 846
    invoke-virtual {v1}, Landroid/support/v7/widget/m;->getAdapter()Landroid/widget/ListAdapter;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/m;->setAdapter(Landroid/widget/ListAdapter;)V
...
.method public setSelection(I)V
    ...
    .line 794
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/m;->setSelection(I)V
    ...
    .line 797
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->getChoiceMode()I
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v7/widget/m;->setItemChecked(IZ)V
...
.method public show()V
    ...
    invoke-virtual {v0, v5}, Landroid/support/v7/widget/m;->setSelection(I)V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/m;->isInTouchMode()Z
