...
.method public static constructor <clinit>()V
    ...
    :cond_0
    sput v2, Lcom/immersion/hapticmediasdk/controllers/MemoryMappedFileReader;->h:I
...
.method private b()Z
    ...
    invoke-virtual {v3, v0, v4, v5}, Ljava/nio/channels/FileChannel;->read(Ljava/nio/ByteBuffer;J)I
    ...
    iget-object v4, p0, Lcom/immersion/hapticmediasdk/controllers/MemoryMappedFileReader;->c:Ljava/nio/channels/FileChannel;
    ...
    new-instance v4, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-direct {v4}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;-><init>()V
    ...
    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setFilePath(Ljava/lang/String;)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;
    ...
    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setTotalFileLength(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;
    ...
    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setMajorVersion(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->get()B

    move-result v0

    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setMinorVersion(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->get()B

    move-result v0

    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setEncoding(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;
    ...
    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setSampleHertz(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;
    ...
    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setBitsPerSample(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->get()B

    move-result v5

    invoke-virtual {v4, v5}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setNumberOfChannels(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;
    ...
    :cond_2
    invoke-virtual {v4, v6}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setActuatorArray([I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->get()B

    move-result v0

    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setCompressionScheme(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;
    ...
    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setHapticDataLength(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-virtual {v3}, Ljava/nio/ByteBuffer;->position()I

    move-result v0

    invoke-virtual {v4, v0}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->setHapticDataStartByteOffset(I)Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;

    invoke-virtual {v4}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation$Builder;->build()Lcom/immersion/hapticmediasdk/models/HapticFileInformation;
    ...
    iget-object v3, p0, Lcom/immersion/hapticmediasdk/controllers/MemoryMappedFileReader;->i:Lcom/immersion/hapticmediasdk/models/HapticFileInformation;

    invoke-virtual {v3}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation;->getSampleHertz()I
    ...
    sget v4, Lcom/immersion/hapticmediasdk/controllers/MemoryMappedFileReader;->bъъ044Aъъъ:I
    ...
    invoke-virtual {v3}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation;->getBitsPerSample()I
    ...
    invoke-virtual {v3}, Lcom/immersion/hapticmediasdk/models/HapticFileInformation;->getNumberOfChannels()I
...
.method private static b(Lrrrrrr/ccrrrr;I)Z
    ...
    iget v2, p0, Lrrrrrr/ccrrrr;->mHapticDataOffset:I
