...
.method public getBufferForPlaybackPosition(I)[B
    ...
    sget v4, Lcom/immersion/hapticmediasdk/controllers/MemoryAlignedFileReader;->b0415ЕЕ0415ЕЕ:I

    sget v5, Lcom/immersion/hapticmediasdk/controllers/MemoryAlignedFileReader;->bЕ041504150415ЕЕ:I
    ...
    sput v4, Lcom/immersion/hapticmediasdk/controllers/MemoryAlignedFileReader;->bЕ0415Е0415ЕЕ:I
    ...
    sget v6, Lcom/immersion/hapticmediasdk/controllers/MemoryAlignedFileReader;->i:I

    if-ge v2, v6, :cond_6

    :goto_2
    invoke-virtual {v4, v1, v5, v2}, Ljava/nio/MappedByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
