...
$( function() {
	...
	$("#lnkSettings").attr("href", settings.settingsUrl);
	$("#btnSettings").on('click', function(){
		interface.transitionToColor("Settings", "orange");
	});

	$("#btnBuilderClub").attr("href", "#");
	$("#btnBuilderClub").on('click', function(){
		interface.openBuilderClubDialog();
	});

	$("#lnkMessages").attr("href", settings.messagesUrl);
	$("#btnMessages").on('click', function(){
		interface.transitionToColor("Messages", "blue");
	});
