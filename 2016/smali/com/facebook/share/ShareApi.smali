...
.method private sharePhotoContent(Lcom/facebook/share/model/SharePhotoContent;Lcom/facebook/FacebookCallback;)V
    ...
    .line 321
    .local v8, "accessToken":Lcom/facebook/AccessToken;
    new-instance v20, Ljava/util/ArrayList;

    invoke-direct/range {v20 .. v20}, Ljava/util/ArrayList;-><init>()V

    .line 322
    .local v20, "requests":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/facebook/GraphRequest;>;"
    ...
    check-cast v18, Lcom/facebook/share/model/SharePhoto;

    .line 353
    .local v18, "photo":Lcom/facebook/share/model/SharePhoto;
    invoke-virtual/range {v18 .. v18}, Lcom/facebook/share/model/SharePhoto;->getBitmap()Landroid/graphics/Bitmap;

    move-result-object v9

    .line 354
    .local v9, "bitmap":Landroid/graphics/Bitmap;
    invoke-virtual/range {v18 .. v18}, Lcom/facebook/share/model/SharePhoto;->getImageUrl()Landroid/net/Uri;

    move-result-object v13

    .line 355
    .local v13, "photoUri":Landroid/net/Uri;
    invoke-virtual/range {v18 .. v18}, Lcom/facebook/share/model/SharePhoto;->getCaption()Ljava/lang/String;
    ...
    .line 365
    invoke-virtual/range {v18 .. v18}, Lcom/facebook/share/model/SharePhoto;->getParameters()Landroid/os/Bundle;
    ...
    .line 360
    invoke-static/range {v7 .. v12}, Lcom/facebook/share/internal/ShareInternalUtility;->newUploadPhotoRequest(Ljava/lang/String;Lcom/facebook/AccessToken;Landroid/graphics/Bitmap;Ljava/lang/String;Landroid/os/Bundle;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;
    ...
    .end local v18    # "photo":Lcom/facebook/share/model/SharePhoto;
    :catch_0
    move-exception v17

    .line 382
    .local v17, "ex":Ljava/io/FileNotFoundException;
    ...
    .line 384
    .end local v17    # "ex":Ljava/io/FileNotFoundException;
    :cond_2
    return-void
    ...
    .restart local v18    # "photo":Lcom/facebook/share/model/SharePhoto;
    :cond_3
    if-eqz v13, :cond_0
    ...
    .line 368
    invoke-static/range {v11 .. v16}, Lcom/facebook/share/internal/ShareInternalUtility;->newUploadPhotoRequest(Ljava/lang/String;Lcom/facebook/AccessToken;Landroid/net/Uri;Ljava/lang/String;Landroid/os/Bundle;Lcom/facebook/GraphRequest$Callback;)Lcom/facebook/GraphRequest;
    ...
    check-cast v19, Lcom/facebook/GraphRequest;

    .line 379
    .local v19, "request":Lcom/facebook/GraphRequest;
    invoke-virtual/range {v19 .. v19}, Lcom/facebook/GraphRequest;->executeAsync()Lcom/facebook/GraphRequestAsyncTask;
    :try_end_1
