...
.method static synthetic access$100(Lmicrosoft/aspnet/signalr/client/http/android/AndroidHttpConnection;)Lmicrosoft/aspnet/signalr/client/Logger;
    .locals 1
    .param p0, "x0"    # Lmicrosoft/aspnet/signalr/client/http/android/AndroidHttpConnection;
...
.method static synthetic access$200(Lmicrosoft/aspnet/signalr/client/http/Request;)Lorg/apache/http/message/BasicHttpEntityEnclosingRequest;
    .locals 1
    .param p0, "x0"    # Lmicrosoft/aspnet/signalr/client/http/Request;
...
.method private static createRealRequest(Lmicrosoft/aspnet/signalr/client/http/Request;)Lorg/apache/http/message/BasicHttpEntityEnclosingRequest;
    ...
    .line 196
    .local v2, "realRequest":Lorg/apache/http/message/BasicHttpEntityEnclosingRequest;
    ...
    invoke-virtual {v2, v3}, Lorg/apache/http/message/BasicHttpEntityEnclosingRequest;->setEntity(Lorg/apache/http/HttpEntity;)V
    ...
    invoke-virtual {v2, v1, v3}, Lorg/apache/http/message/BasicHttpEntityEnclosingRequest;->addHeader(Ljava/lang/String;Ljava/lang/String;)V
...
.method private executeTask(Landroid/os/AsyncTask;)V
    ...
    .prologue
    .local p1, "task":Landroid/os/AsyncTask;, "Landroid/os/AsyncTask<Ljava/lang/Void;Ljava/lang/Void;Ljava/lang/Void;>;"
    const/4 v2, 0x0
...
.method public execute(Lmicrosoft/aspnet/signalr/client/http/Request;Lmicrosoft/aspnet/signalr/client/http/HttpConnectionFuture$ResponseCallback;)Lmicrosoft/aspnet/signalr/client/http/HttpConnectionFuture;
    ...
    .param p2, "responseCallback"    # Lmicrosoft/aspnet/signalr/client/http/HttpConnectionFuture$ResponseCallback;

    .prologue
    .line 59
    iget-object v2, p0, Lmicrosoft/aspnet/signalr/client/http/android/AndroidHttpConnection;->mLogger:Lmicrosoft/aspnet/signalr/client/Logger;

    const-string v3, "Create new AsyncTask for HTTP Connection"
    ...
    .line 143
    .local v1, "requestTask":Lmicrosoft/aspnet/signalr/client/http/android/AndroidHttpConnection$RequestTask;
