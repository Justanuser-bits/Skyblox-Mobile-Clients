...
.method public run(Lmicrosoft/aspnet/signalr/client/hubs/HubResult;)V
    .locals 8
    .param p1, "result"    # Lmicrosoft/aspnet/signalr/client/hubs/HubResult;

    .prologue
    .line 325
    iget-object v4, p0, Lmicrosoft/aspnet/signalr/client/hubs/HubProxy$5;->this$0:Lmicrosoft/aspnet/signalr/client/hubs/HubProxy;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "Executing invocation callback for: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-object v6, p0, Lmicrosoft/aspnet/signalr/client/hubs/HubProxy$5;->val$method:Ljava/lang/String;
    ...
    .line 329
    iget-object v4, p0, Lmicrosoft/aspnet/signalr/client/hubs/HubProxy$5;->val$resultFuture:Lmicrosoft/aspnet/signalr/client/SignalRFuture;

    new-instance v5, Lmicrosoft/aspnet/signalr/client/hubs/HubException;
    ...
    invoke-direct {v5, v6, v7}, Lmicrosoft/aspnet/signalr/client/hubs/HubException;-><init>(Ljava/lang/String;Ljava/lang/Object;)V

    invoke-virtual {v4, v5}, Lmicrosoft/aspnet/signalr/client/SignalRFuture;->triggerError(Ljava/lang/Throwable;)V
    ...
    .line 335
    .local v1, "errorHappened":Z
    const/4 v3, 0x0

    .line 337
    .local v3, "resultObject":Ljava/lang/Object;, "TE;"
    :try_start_0
    ...
    iget-object v6, p0, Lmicrosoft/aspnet/signalr/client/hubs/HubProxy$5;->this$0:Lmicrosoft/aspnet/signalr/client/hubs/HubProxy;
    ...
    invoke-virtual {v6, v2, v4}, Lmicrosoft/aspnet/signalr/client/hubs/HubProxy;->setState(Ljava/lang/String;Lcom/google/gson/JsonElement;)V
    :try_end_0
    ...
    invoke-virtual {v4, v0}, Lmicrosoft/aspnet/signalr/client/SignalRFuture;->triggerError(Ljava/lang/Throwable;)V

    .line 352
    .end local v0    # "e":Ljava/lang/Exception;
    .end local v3    # "resultObject":Ljava/lang/Object;, "TE;"
    :cond_3
    :goto_2
    if-nez v1, :cond_0
    ...
    invoke-virtual {v4, v3}, Lmicrosoft/aspnet/signalr/client/SignalRFuture;->setResult(Ljava/lang/Object;)V
    :try_end_1
    ...
    .line 343
    .end local v0    # "e":Ljava/lang/Exception;
    .restart local v3    # "resultObject":Ljava/lang/Object;, "TE;"
    :cond_4
    :try_start_2
    invoke-virtual {p1}, Lmicrosoft/aspnet/signalr/client/hubs/HubResult;->getResult()Lcom/google/gson/JsonElement;
    ...
    const-string v6, "Found result invoking method on hub: "
    ...
    iget-object v6, p0, Lmicrosoft/aspnet/signalr/client/hubs/HubProxy$5;->val$resultType:Ljava/lang/reflect/Type;
