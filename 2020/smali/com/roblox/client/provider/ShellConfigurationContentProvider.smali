...
.field private c:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lcom/roblox/client/provider/a/d;",
            ">;"
        }
    .end annotation
.end field
...
.method private a(Ljava/lang/String;Lcom/roblox/client/provider/a/d;)V
    .locals 1

    .line 55
    sget-object v0, Lcom/roblox/client/provider/a/d$a;->a:Lcom/roblox/client/provider/a/d$a;

    invoke-interface {p2, v0}, Lcom/roblox/client/provider/a/d;->a(Lcom/roblox/client/provider/a/d$a;)Lcom/roblox/client/f/a;

    move-result-object v0

    invoke-direct {p0, p1, p2, v0}, Lcom/roblox/client/provider/ShellConfigurationContentProvider;->a(Ljava/lang/String;Lcom/roblox/client/provider/a/d;Lcom/roblox/client/f/a;)V
...
.method private a(Ljava/lang/String;Lcom/roblox/client/provider/a/d;Lcom/roblox/client/f/a;)V
    .locals 3
    ...
    iget-object v1, p3, Lcom/roblox/client/f/a;->e:Ljava/lang/String;

    iget v2, p3, Lcom/roblox/client/f/a;->f:I
    ...
    iget p3, p3, Lcom/roblox/client/f/a;->f:I
...
.method private c()V
    ...
    invoke-direct {v1}, Lcom/roblox/client/provider/a/c;-><init>()V

    invoke-direct {p0, v0, v1}, Lcom/roblox/client/provider/ShellConfigurationContentProvider;->a(Ljava/lang/String;Lcom/roblox/client/provider/a/d;)V

    .line 50
    new-instance v1, Lcom/roblox/client/provider/a/b;

    invoke-direct {v1, p0}, Lcom/roblox/client/provider/a/b;-><init>(Lcom/roblox/client/provider/ShellConfigurationContentProvider;)V

    invoke-direct {p0, v0, v1}, Lcom/roblox/client/provider/ShellConfigurationContentProvider;->a(Ljava/lang/String;Lcom/roblox/client/provider/a/d;)V

    .line 51
    new-instance v1, Lcom/roblox/client/provider/a/e;

    invoke-virtual {p0}, Lcom/roblox/client/provider/ShellConfigurationContentProvider;->getContext()Landroid/content/Context;

    move-result-object v2

    invoke-direct {v1, v2}, Lcom/roblox/client/provider/a/e;-><init>(Landroid/content/Context;)V
...
.method public insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    check-cast v0, Lcom/roblox/client/provider/a/d;

    if-eqz v0, :cond_0

    .line 98
    invoke-interface {v0, p1, p2}, Lcom/roblox/client/provider/a/d;->a(Landroid/net/Uri;Landroid/content/ContentValues;)V
...
.method public query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    check-cast p2, Lcom/roblox/client/provider/a/d;

    if-eqz p2, :cond_0

    .line 80
    invoke-interface {p2, p1}, Lcom/roblox/client/provider/a/d;->a(Landroid/net/Uri;)Landroid/database/Cursor;
