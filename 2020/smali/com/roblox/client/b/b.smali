...
.method public a(Landroid/app/Activity;)V
    ...
    const-string v3, "PREF_DONT_SHOW_AGAIN_FOR_THIS_VERSION"
    ...
    const-string v8, "PREF_LONGEST_GAME_DURATION"
    ...
    .line 264
    iget-object v5, v0, Lcom/roblox/client/b/b;->b:Landroid/content/SharedPreferences;

    const-string v10, "PREF_TIME_OF_ABSOLUTE_FIRST_LAUNCH"

    invoke-interface {v5, v10, v6, v7}, Landroid/content/SharedPreferences;->getLong(Ljava/lang/String;J)J
    ...
    invoke-interface {v5, v12, v6, v7}, Landroid/content/SharedPreferences;->getLong(Ljava/lang/String;J)J
    ...
    .line 273
    iget v2, v0, Lcom/roblox/client/b/b;->c:I

    if-lt v4, v2, :cond_6

    sub-long v10, v8, v10

    iget v2, v0, Lcom/roblox/client/b/b;->d:I
    ...
    const-string v2, "Enough time until initial prompt."
    ...
    .line 277
    iget v2, v0, Lcom/roblox/client/b/b;->e:I

    if-lt v5, v2, :cond_4

    sub-long v4, v8, v13

    iget v2, v0, Lcom/roblox/client/b/b;->f:I
    ...
    :cond_4
    const-string v2, "User has seen a prompt recently || (Not enough launches since last prompt || Not enough time since last prompt)"
    ...
    :cond_5
    :goto_0
    const-string v2, "User has not seen a prompt || (Enough launches since last prompt && Enough time since last prompt)"

    .line 279
    invoke-static {v3, v2}, Lcom/roblox/client/ae/k;->c(Ljava/lang/String;Ljava/lang/String;)I

    .line 281
    invoke-interface {v1, v12, v8, v9}, Landroid/content/SharedPreferences$Editor;->putLong(Ljava/lang/String;J)Landroid/content/SharedPreferences$Editor;
    ...
    :cond_6
    const-string v2, "Not enough time until initial prompt."
...
.method public a(Landroid/content/Context;)V
    ...
    const-string v3, "PREF_TIME_OF_ABSOLUTE_FIRST_LAUNCH"
