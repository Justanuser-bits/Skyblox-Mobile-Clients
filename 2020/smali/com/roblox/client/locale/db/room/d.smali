...
.method public a(Ljava/lang/String;)Lcom/roblox/client/locale/db/room/b;
    ...
    const-string v1, "SELECT * FROM Strings WHERE robloxLocaleValue = ?"

    .line 83
    invoke-static {v1, v0}, Landroidx/h/h;->a(Ljava/lang/String;I)Landroidx/h/h;
    ...
    .line 86
    invoke-virtual {v1, v0}, Landroidx/h/h;->a(I)V

    goto :goto_0

    .line 88
    :cond_0
    invoke-virtual {v1, v0, p1}, Landroidx/h/h;->a(ILjava/lang/String;)V

    .line 90
    :goto_0
    iget-object p1, p0, Lcom/roblox/client/locale/db/room/d;->a:Landroidx/h/e;

    invoke-virtual {p1, v1}, Landroidx/h/e;->a(Landroidx/i/a/e;)Landroid/database/Cursor;
    ...
    invoke-direct {v3, v0, v2}, Lcom/roblox/client/locale/db/room/b;-><init>(Ljava/lang/String;Ljava/util/HashMap;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 109
    invoke-virtual {v1}, Landroidx/h/h;->a()V
